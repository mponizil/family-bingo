    ...
    return (
      <View style={[styles.screen, {flex: 1, justifyContent: 'flex-start', alignItems: 'center', paddingVertical: 60, paddingHorizontal: 60}]}>
        ...
        <View style={{marginBottom: 40}}>
          <Text style={styles.heading}>Come enjoy this years Thanksgiving <Text style={{fontStyle: 'italic', color: '#571f1f'}}>app</Text> (itizer). Play Family Bingo and win your tickets for dessert. Let's get started!</Text>
